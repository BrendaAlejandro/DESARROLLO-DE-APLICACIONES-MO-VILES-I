...
public class ValidacionUtil {
    ...
    //Proveedor Registro
    public static final String RazonSocial = "[a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s]{4,40}";
    public static final String TELEFONO = "[0-9]{9}";
    public static final String RUC = "^10\\d{9}$";


    public static final String DIRECCION_XD = "(?=.*\\d{1,3})([a-zA-ZáéíóúñüÁÉÍÓÚÑÜ\\s0-9]{1,20})";


    public static final String TELEFONO_PROV = "^\\d{9}$";
